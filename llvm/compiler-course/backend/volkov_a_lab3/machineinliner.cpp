...
private:
  bool shouldInlineCall(MachineInstr &CallInst,
                        DenseMap<const Function *, unsigned> &DepthMap) {
...
RegisterPass<VolkovInlinePass> X("volkov-inline",
                                 "Volkov A. Function Inlining Pass");
